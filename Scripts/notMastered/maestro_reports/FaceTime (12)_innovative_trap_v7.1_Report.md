...
```json
{
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.415248467358465,
    "gain_db_total": 5.065883508450879,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.8381245952129206,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.1836536765799904,
      "true_peak_dbfs": -1.0000002900227403,
      "ceiling_chase_strength": 1.05
    }
  },
