...
![EQ Delta](Fall in Love_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](Fall in Love_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](Fall in Love_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "target": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\notMastered\\Fall in Love.wav",
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\Fall in Love_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.195198893806882,
    "gain_db_total": -1.4462990364702435,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.3860591684707998,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.012354836345502943,
      "true_peak_dbfs": -1.0000008709134622,
      "ceiling_chase_strength": 1.05
    }
  },
  "pre": {
    "lufs": -14.752081255117949,
    "true_peak_dbfs": -0.15627104992922344,
    "peak_dbfs": -0.17377212395020383
  },
  "post": {
    "lufs": -10.202026386188576,
    "true_peak_dbfs": -1.0000008709134622,
    "peak_dbfs": -1.0341067789512353
  },
  "plots": {
    "eq_delta": "Fall in Love_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "Fall in Love_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "Fall in Love_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```