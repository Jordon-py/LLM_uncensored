...
![EQ Delta](FaceTime (10)_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](FaceTime (10)_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](FaceTime (10)_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "target": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\notMastered\\FaceTime (10).wav",
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\FaceTime (10)_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.407105921008542,
    "gain_db_total": 4.360892409588514,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.33203924073830393,
      "true_peak_dbfs": -1.0000002900227403,
      "ceiling_chase_strength": 1.05
    }
  },
  "pre": {
    "lufs": -17.024850348284044,
    "true_peak_dbfs": -0.7764520681854038,
    "peak_dbfs": -0.8157459595821476
  },
  "post": {
    "lufs": -10.48172845698714,
    "true_peak_dbfs": -1.0000002900227403,
    "peak_dbfs": -1.0057791700315581
  },
  "plots": {
    "eq_delta": "FaceTime (10)_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "FaceTime (10)_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "FaceTime (10)_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```