...
![EQ Delta](back2back_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](back2back_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](back2back_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "target": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\notMastered\\back2back.wav",
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\back2back_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "stem_block": {
    ...
    "vocals_deess": {
      ...
      "threshold_db": -22.0,
      "ratio": 2.0,
      "min_gain_db": -1.9326338429663577
    },
    "key_glow": {
      "enabled": true,
      "other": {
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.465675773807478,
    "gain_db_total": -1.230688873694337,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.9838769583899156,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.006301376717489676,
      "true_peak_dbfs": -1.0000008709134622,
      "ceiling_chase_strength": 1.05
    }
  },
  "pre": {
    "lufs": -12.079891325315401,
    "true_peak_dbfs": 0.3525141574124556,
    "peak_dbfs": 0.3467356019352575
  },
  "post": {
    "lufs": -10.46788567543384,
    "true_peak_dbfs": -1.0000008709134622,
    "peak_dbfs": -1.0139709038293747
  },
  "plots": {
    "eq_delta": "back2back_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "back2back_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "back2back_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```