...
![EQ Delta](Fall in Love (1)_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](Fall in Love (1)_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](Fall in Love (1)_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "target": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\notMastered\\Fall in Love (1).wav",
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\Fall in Love (1)_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.33498901218287,
    "gain_db_total": 2.306138160987002,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.8949571650660944,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.06605003941210996,
      "true_peak_dbfs": -0.9999997091320568,
      "ceiling_chase_strength": 1.05
    }
  },
  "pre": {
    "lufs": -17.062492754893338,
    "true_peak_dbfs": 0.06375349740592814,
    "peak_dbfs": 0.031928020075722166
  },
  "post": {
    "lufs": -10.356600833769235,
    "true_peak_dbfs": -0.9999997091320568,
    "peak_dbfs": -1.0225064076468113
  },
  "plots": {
    "eq_delta": "Fall in Love (1)_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "Fall in Love (1)_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "Fall in Love (1)_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```