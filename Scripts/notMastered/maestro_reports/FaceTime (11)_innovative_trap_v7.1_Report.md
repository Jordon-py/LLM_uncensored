...
![EQ Delta](FaceTime (11)_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](FaceTime (11)_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](FaceTime (11)_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "target": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\notMastered\\FaceTime (11).wav",
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\FaceTime (11)_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.255320517602463,
    "gain_db_total": 0.18227158532817,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.6126618709750868,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.03150073790760531,
      "true_peak_dbfs": -1.0000014518042233,
      "ceiling_chase_strength": 1.05
    }
  },
  "pre": {
    "lufs": -13.553168000849126,
    "true_peak_dbfs": 0.17751472764345547,
    "peak_dbfs": 0.16062325220971754
  },
  "post": {
    "lufs": -10.264314565094782,
    "true_peak_dbfs": -1.0000014518042233,
    "peak_dbfs": -1.011498496202603
  },
  "plots": {
    "eq_delta": "FaceTime (11)_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "FaceTime (11)_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "FaceTime (11)_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```