...
![EQ Delta](Fire_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](Fire_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](Fire_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\Fire_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.702827102661118,
    "gain_db_total": 5.14971672672954,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -1.7562435735468545,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.09321573033755148,
      "true_peak_dbfs": -0.9999985473508068,
      "ceiling_chase_strength": 1.05
    }
  },
  "pre": {
    "lufs": -15.739984236372939,
    "true_peak_dbfs": 0.1707819783134858,
    "peak_dbfs": 0.12551171722272336
  },
  "post": {
    "lufs": -10.72654237460282,
    "true_peak_dbfs": -0.9999985473508068,
    "peak_dbfs": -1.0143677180715902
  },
  "plots": {
    "eq_delta": "Fire_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "Fire_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "Fire_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```