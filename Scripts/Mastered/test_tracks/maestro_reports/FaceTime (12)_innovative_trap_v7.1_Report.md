...
![EQ Delta](FaceTime (12)_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](FaceTime (12)_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](FaceTime (12)_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\FaceTime (12)_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.409382134921595,
    "gain_db_total": 5.056699686411417,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.8352263593591427,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.1928207271335403,
  ...
  "post": {
    "lufs": -10.453060717324698,
    "true_peak_dbfs": -1.0000002900227403,
    "peak_dbfs": -1.0057791700315581
  },
  "plots": {
    "eq_delta": "FaceTime (12)_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "FaceTime (12)_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "FaceTime (12)_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```