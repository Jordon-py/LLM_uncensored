...
![EQ Delta](Vegas - top teir (14)_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](Vegas - top teir (14)_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](Vegas - top teir (14)_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\Vegas - top teir (14)_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.4064234588441,
    "gain_db_total": 2.4053130292168774,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.7106840099925166,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.10092063192066378,
      "true_peak_dbfs": -1.0000002900227403,
      "ceiling_chase_strength": 1.05
    }
  },
  ...
  "post": {
    "lufs": -10.432403123311563,
    "true_peak_dbfs": -1.0000002900227403,
    "peak_dbfs": -1.0057791700315581
  },
  "plots": {
    "eq_delta": "Vegas - top teir (14)_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "Vegas - top teir (14)_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "Vegas - top teir (14)_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```