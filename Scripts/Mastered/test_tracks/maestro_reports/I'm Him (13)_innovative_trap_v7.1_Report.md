...
![EQ Delta](I'm Him (13)_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](I'm Him (13)_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](I'm Him (13)_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\I'm Him (13)_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.582921510178808,
    "gain_db_total": 0.6355397556176801,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -1.1572294342942326,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.009017655877871582,
  ...
  "post": {
    "lufs": -10.583825729940656,
    "true_peak_dbfs": -1.0000002900227403,
    "peak_dbfs": -1.0057791700315581
  },
  "plots": {
    "eq_delta": "I'm Him (13)_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "I'm Him (13)_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "I'm Him (13)_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```