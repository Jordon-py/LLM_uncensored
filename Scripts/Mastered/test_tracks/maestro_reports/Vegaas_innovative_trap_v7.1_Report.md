...
![EQ Delta](Vegaas_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](Vegaas_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](Vegaas_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\Vegaas_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.417863189463466,
    "gain_db_total": 3.353667194553015,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.9313674873333264,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.037285296124670325,
  ...
  "post": {
    "lufs": -10.425178868154026,
    "true_peak_dbfs": -0.9999997091320568,
    "peak_dbfs": -1.007870276203982
  },
  "plots": {
    "eq_delta": "Vegaas_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "Vegaas_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "Vegaas_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```