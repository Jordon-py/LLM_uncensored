...
![EQ Delta](SOMEBODY (1)_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](SOMEBODY (1)_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](SOMEBODY (1)_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\SOMEBODY (1)_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "stem_block": {
    ...
    "vocals_deess": {
      ...
      "threshold_db": -22.0,
      "ratio": 2.0,
      "min_gain_db": -0.02309092176146735
    },
    "key_glow": {
      "enabled": true,
      "other": {
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.226348548535187,
    "gain_db_total": -0.9714531388390402,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.47166306406896974,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.028875074556940827,
  ...
  "post": {
    "lufs": -10.226202893508614,
    "true_peak_dbfs": -1.000002032695023,
    "peak_dbfs": -1.006027960282576
  },
  "plots": {
    "eq_delta": "SOMEBODY (1)_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "SOMEBODY (1)_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "SOMEBODY (1)_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```