...
![EQ Delta](Goku_balanced_v7_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](Goku_balanced_v7_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](Goku_balanced_v7_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\Goku_balanced_v7_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "stem_block": {
    ...
    "vocals_deess": {
      ...
      "threshold_db": -22.0,
      "ratio": 2.0,
      "min_gain_db": -2.6931989808764185
    },
    "key_glow": {
      "enabled": true,
      "other": {
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -11.4,
    "final_lufs": -10.964118620190016,
    "gain_db_total": -0.8872154710691351,
    "target_peak_dbfs": -1.0,
    "final_true_peak_dbfs": -0.9999979664602403,
    "iters": 2,
    "limiter": {
      "enabled": true,
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.39100434728872535,
      "true_peak_dbfs": -0.9999979664602403,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.003505667467851694,
  ...
  "post": {
    "lufs": -10.963035311573467,
    "true_peak_dbfs": -1.0000002900227403,
    "peak_dbfs": -1.0139185396675219
  },
  "plots": {
    "eq_delta": "Goku_balanced_v7_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "Goku_balanced_v7_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "Goku_balanced_v7_v7.1_Report_Scale_Shimmer.png"
  }
}
```