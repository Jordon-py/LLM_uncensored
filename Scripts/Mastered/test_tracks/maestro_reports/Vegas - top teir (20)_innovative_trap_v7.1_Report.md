...
![EQ Delta](Vegas - top teir (20)_innovative_trap_v7.1_Report_EQ_Delta.png)

## Spectrum Overlay

![Spectrum](Vegas - top teir (20)_innovative_trap_v7.1_Report_Spectrum_Overlay.png)

## Scale Shimmer Bands

![Scale Shimmer](Vegas - top teir (20)_innovative_trap_v7.1_Report_Scale_Shimmer.png)
...
```json
{
  ...
  "paths": {
    ...
    "out": "C:\\Users\\goku\\LLM_uncensored\\Scripts\\Mastered\\test_tracks_mastered\\Vegas - top teir (20)_innovative_trap_v7.1.wav"
  },
  "stems": {
    "enabled": true,
    "model": "htdemucs",
  ...
  "match_eq": {
    ...
    "eq_curve": {
      ...
      "delta_db": [
        ...
        0.6218450665473938,
        -0.4210292398929596,
        -0.043251506984233856,
        0.22238801419734955,
        0.022215401753783226,
        0.1745271533727646,
        0.19870375096797943,
        0.5401351451873779,
        1.9078888893127441,
  ...
  "finalize": {
    "enabled": true,
    "target_lufs": -10.7,
    "final_lufs": -10.631701159807264,
    "gain_db_total": 4.470965809194849,
    ...
    "limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -1.3718965570492456,
  ...
  "transient_restore": {
    ...
    "post_tp_limiter": {
      ...
      "ceiling_dbfs": -1.0,
      "tp_oversample": 8,
      "min_gain_db": -0.050406172762005444,
  ...
  "post": {
    "lufs": -10.639908437244959,
    "true_peak_dbfs": -1.0000008709134622,
    "peak_dbfs": -1.0140110499005852
  },
  "plots": {
    "eq_delta": "Vegas - top teir (20)_innovative_trap_v7.1_Report_EQ_Delta.png",
    "spectrum_overlay": "Vegas - top teir (20)_innovative_trap_v7.1_Report_Spectrum_Overlay.png",
    "scale_shimmer": "Vegas - top teir (20)_innovative_trap_v7.1_Report_Scale_Shimmer.png"
  }
}
```